...
public class BuffConfigModel extends ConfigModel {
	...
	public ArrArrInt deathTimings;//销毁时机
	public ArrArrInt triggerTiming;//触发时机
	...
	public ArrArrInt attrs;//改变属性
	public ArrInt attrleveup;//改变属性等级成长
	public ArrInt skillCycle;//替换原有普通技能循环

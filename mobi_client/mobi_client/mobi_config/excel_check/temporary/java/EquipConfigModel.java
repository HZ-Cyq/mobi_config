...
public class EquipConfigModel extends ConfigModel {
	...
	public ArrInt random_attribute_list;//随机属性（当前版本固定）
	public ArrInt random_attribute_num;//随机属性数值（当前版本固定）
	public ArrInt random_attribute_weight;//随机属性获得权重(属性顺序；千分之几）
